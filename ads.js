...
(() => {
  ...
  function apply(){const slot=document.querySelector('.ad-slot');if(!slot)return;slot.hidden=!cfg.enabled;slot.dataset.density=cfg.density;const badge=slot.querySelector('.ad-badge');if(badge)badge.hidden=!cfg.label}
  function open(){
