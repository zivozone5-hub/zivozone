...
(() => {
  ...
  function apply(){document.querySelectorAll('.ad-slot').forEach(slot=>{slot.hidden=!cfg.enabled;slot.dataset.density=cfg.density;const badge=slot.querySelector('.ad-badge');if(badge)badge.hidden=!cfg.label})}
  function open(){
