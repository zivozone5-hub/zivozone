...
(() => {
  ...
  async function refresh(){
    ...
    syncUI();window.dispatchEvent(new CustomEvent('zivozone-wallet-updated',{detail:{zivo:state.zivo,ledger:state.ledger,nextMiningAt:state.nextMiningAt}}));return state;
  }

  function syncUI(){
    state.coins=Number(state.zivo)||0;
