...
(function(){
  ...
  function sanitize(x){
    ...
    return {
      ...
      questionIds:Array.isArray(x.questionIds)?x.questionIds.slice(0,100).map(v=>String(v).slice(0,100)):[],
