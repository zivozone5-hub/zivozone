const CACHE='zivozone-shell-v1089-1';
const SHELL=['/','/index.html','/manifest.webmanifest','/zivo-styles.bundle.css','/zivo-scripts.bundle.js','/zivo-ai.js','/zivo-core-v1089.js'];
