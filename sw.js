const CACHE='zivozone-shell-v1082-1';
const SHELL=['/','/index.html','/manifest.webmanifest','/zivo-styles.bundle.css','/zivozone-runtime.js','/zivo-global-core.js','/zivo-v103-pro.js','/zivo-v104-pro.js','/zivo-v105-luxury.js','/zivo-v1062-royal.js','/zivo-ai.js'];
