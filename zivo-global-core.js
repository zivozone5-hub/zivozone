...
(() => {
  ...
  function injectStyle(){
    ...
    const s=document.createElement('style');s.id='zivo-v101-style';s.textContent=`
      ...
      .z101-economy{width:min(1180px,calc(100% - 28px));margin:14px auto 10px;display:grid;grid-template-columns:1.08fr .92fr;gap:12px;position:relative;z-index:3}
      .z101-card{border:1px solid rgba(255,215,70,.20);border-radius:18px;background:linear-gradient(145deg,rgba(255,215,70,.10),rgba(16,20,31,.96) 55%,rgba(255,255,255,.025));box-shadow:0 16px 42px rgba(0,0,0,.22),inset 0 1px 0 rgba(255,255,255,.04);padding:14px 15px;position:relative;overflow:hidden}.z101-card:before{content:'';position:absolute;inset:-70% -20%;background:linear-gradient(105deg,transparent 43%,rgba(255,255,255,.06) 50%,transparent 57%);transform:translateX(-35%);animation:z101Sheen 8s ease-in-out infinite;pointer-events:none}@keyframes z101Sheen{0%,55%,100%{transform:translateX(-35%)}72%{transform:translateX(35%)}}
      .z101-wallet{display:flex;align-items:center;gap:12px;min-height:82px}.z101-coin{width:48px;height:48px;flex:0 0 48px;border-radius:50%;display:grid;place-items:center;background:radial-gradient(circle at 30% 25%,#fff7bd,#ffd43d 44%,#9c6700);border:2px solid #ffe889;color:#5b3900;font-weight:1000;font-size:21px;box-shadow:inset 0 2px 5px rgba(255,255,255,.55),0 0 26px rgba(255,211,61,.14)}
      .z101-label{font-size:10px;opacity:.68;font-weight:1000;letter-spacing:.08em}.z101-balance{font-size:24px;font-weight:1000;color:#ffe06a;line-height:1.1;margin-top:4px}.z101-sub{font-size:10px;opacity:.62;margin-top:5px}.z101-wallet-actions{margin-inline-start:auto;position:relative;z-index:2}.z101-btn{border:1px solid rgba(255,255,255,.12);background:rgba(255,255,255,.06);color:#fff;border-radius:11px;padding:9px 12px;font-weight:950;cursor:pointer}.z101-btn.primary{background:linear-gradient(90deg,#ffd43d,#ffed8a);color:#17120a;border-color:#ffd43d}.z101-btn:disabled{opacity:.5;cursor:not-allowed}
      .z101-mining{display:flex;align-items:center;gap:11px;min-height:82px}.z101-mining-icon{font-size:30px;filter:drop-shadow(0 0 10px rgba(255,211,61,.18))}.z101-mining h3{margin:0;font-size:14px}.z101-mining p{margin:3px 0 0;font-size:9px;opacity:.65}.z101-mine-action{margin-inline-start:auto;min-width:150px;position:relative;z-index:2}.z101-countdown{font-size:13px;font-weight:1000;color:#ffe06a;margin-top:5px;letter-spacing:.5px}.z101-ready{color:#7df0a4}.z101-ledger{margin-top:12px;border-top:1px solid rgba(255,255,255,.07);padding-top:8px}.z101-ledger-title{font-size:10px;opacity:.6;font-weight:900}.z101-ledger-list{max-height:110px;overflow:auto}.z101-ledger-row{display:grid;grid-template-columns:1fr auto;gap:8px;padding:7px 0;border-bottom:1px solid rgba(255,255,255,.05);font-size:10px}.z101-ledger-row b{color:#ffe06a}.z101-ledger-row small{grid-column:1/-1;opacity:.45}.z101-note{font-size:9px;opacity:.55;margin-top:9px;line-height:1.5}
      ...
      @media(max-width:760px){.z101-economy{grid-template-columns:1fr;width:calc(100% - 20px);margin:10px auto 14px;gap:9px}.z101-card{padding:12px;border-radius:16px}.z101-wallet,.z101-mining{min-height:70px}.z101-coin{width:42px;height:42px;flex-basis:42px;font-size:18px}.z101-balance{font-size:21px}.z101-label{font-size:8px}.z101-sub{font-size:8px}.z101-wallet-actions{margin-inline-start:auto;display:block}.z101-mining-icon{font-size:25px}.z101-mining p{display:none}.z101-mine-action{min-width:118px}.z101-btn{padding:10px 10px;font-size:10px}.z101-countdown{font-size:11px}.z101-ready{color:#7df0a4}}
  ...
  function mountHub(){
    ...
    if(home) home.insertAdjacentElement('afterend',root);
