/* ============================================================
   ZIVOZONE CLEAN CORE — V1081 BASELINE
   Consolidated runtime: existing functionality preserved.
   This file is the single local JavaScript application entrypoint.
============================================================ */
...
/* ===== MERGED: sw.js ===== */
const CACHE='zivozone-shell-v1064-1';
const SHELL=['/','/index.html','/manifest.webmanifest','/styles.css','/zivozone-runtime.js','/zivo-global-core.js','/zivo-v103-pro.css','/zivo-v103-pro.js','/zivo-v104-pro.css','/zivo-v104-pro.js','/zivo-v105-luxury.css','/zivo-v105-luxury.js','/zivo-v1062-royal.css','/zivo-v1062-royal.js','/zivo-ai.js'];
